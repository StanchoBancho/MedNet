...
{
    UIView *postedView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, size.width, size.height)];
    ...
    UIImageView *checkMark = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"first"]];
    [postedView addSubview:checkMark];
    checkMark.center = CGPointMake(postedView.frame.size.width / 2.0f, 25);
    
    UILabel *postLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 25.0f, size.width, size.height - 25.0f)];
...
{
    UIView *postedView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 100, 100)];
    postedView.backgroundColor = [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0.7];
    postedView.layer.cornerRadius = 10.0;
    postedView.clipsToBounds = YES;
    ...
    UILabel *postLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 40, 100, 60)];
    postLabel.textAlignment = NSTextAlignmentCenter;
    postLabel.numberOfLines = 0;
    postLabel.textColor = [UIColor whiteColor];
    [postLabel setText:title];
